...
import { callChatbotAPI } from '../services/geminiService.js'
...
const AIAssistant = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'ai',
      text: 'Hello! Welcome to Help & Support. How can I assist you today?'
    }
  ])
  ...
  useEffect(() => {
    ...
    return () =>
      document.removeEventListener('notification-opened', handleNotificationToggle)
  }, [isOpen])
  ...
  const handleSendMessage = async (e) => {
    ...
    const aiResponse = await callChatbotAPI(
      ...
      import.meta.env.VITE_GEMINI_API_KEY // ✅ Use environment variable here
    )
    ...
    setMessages((prev) => [
      ...prev,
      {
        ...
        text:
          aiResponse ||
          "I'm here to help! You can ask me about using the dashboard, uploading files, analyzing resumes, or managing applications."
      }
    ])
          ...
          <div className="flex flex-col h-80">
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              ...
              <div className="flex items-center justify-center space-x-4 text-xs">
                <a
                  href="mailto:gokulakrishnans431@gmail.com"
                  className="flex items-center space-x-1 text-blue-600 dark:text-blue-400"
                >
                  <Mail className="w-3 h-3" />
                  <span>gokulakrishnans431@gmail.com</span>
                </a>
                <a
                  href="tel:9788362699"
