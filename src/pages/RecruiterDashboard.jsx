...
import  { Users, FileText, BarChart3, Upload, MessageCircle, Settings, Trash, Eye, Download, Share, CheckCircle, Zap, Mail, Activity, Star } from 'lucide-react'  
...
const     RecruiterDashboard = () => {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('navigate-to-tab', handleTabNavigation)
  }, []) 
